...
export const getRenderString = (data: HTMLTemplateResult) => {
  ...
  const v: string[] = [...(values as string[] | object[]), ""].map((e) =>
    typeof e === "object" ? getRenderString(e as HTMLTemplateResult) : e
  )
  return strings.reduce((acc, s, i) => acc + s + v[i], "")
}

export const renderLitMiddleware: Application.Middleware<
